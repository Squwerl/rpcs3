...
struct cfg_root : cfg::node
{
	...
	public:
		...
		cfg::_int<-1, 14> ppu_128_reservations_loop_max_length{ this, "Accurate PPU 128-byte Reservation Op Max Length", false, true }; // -1: Always accurate, 0: Never accurate, 1-14: max accurate loop length
